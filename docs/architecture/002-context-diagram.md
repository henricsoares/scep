...
The expected future Data Scientist workflow consumes authorized datasets generated by SCEP and
performs model development in the AI Research Environment. Current SPEC-011 authorization remains
unchanged until the research-identity debt is resolved. An authorized prediction publisher may
